...
void Initialize()
{
	Set_Clock(); // include stop sleep mode
	/*************test******************/
	...
	//Write_Bytes(I2C_MST_CTRL, MPU9250_ADDRESS_DEFAULT, 0x00);
	Write_Bytes(SMPLRT_DIV, MPU9250_ADDRESS_DEFAULT, 0x04);
  Write_Bytes(CONFIG, MPU9250_ADDRESS_DEFAULT, 0x03);
	u8 *c = new u8[1];
	//Write_Bytes(USER_CTRL, MPU9250_ADDRESS_DEFAULT, 0x20);
	Read_data_buffer(ACCEL_CONFIG2,c , MPU9250_ADDRESS_DEFAULT, 1);
	Write_Bytes(ACCEL_CONFIG2, MPU9250_ADDRESS_DEFAULT,(c[0] & ~0x0F));
	Write_Bytes(ACCEL_CONFIG2, MPU9250_ADDRESS_DEFAULT,(c[0] | 0x03));
	Set_Gyro_Range();
	Set_Accel_Range();
	delete c;
}
...
void Set_Clock()
{
	Write_Bytes(PWR_MGMT_1, MPU9250_ADDRESS_DEFAULT, 0x00);
	delay(10000);
	Write_Bytes(PWR_MGMT_1, MPU9250_ADDRESS_DEFAULT, 0x02);
	delay(10000);
}
/***********************************************************************************
*
...
void Set_Gyro_Range()
{
	Write_Bytes(GYRO_CONFIG, MPU9250_ADDRESS_DEFAULT, MPU9250_GYRO_FS_250);
}
/***********************************************************************************
*
*
***********************************************************************************/
void Set_Accel_Range()
{
	Write_Bytes(ACCEL_CONFIG, MPU9250_ADDRESS_DEFAULT, MPU9250_ACCEL_FS_2);
}
/***********************************************************************************
*
*
